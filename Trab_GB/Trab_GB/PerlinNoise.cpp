...
float PerlinNoise::perlin(float x, float y) {
    ...
    //float rangeMin = 0.0;  // Custom minimum value of the range
    //float rangeMax = 149.0; // Custom maximum value of the range

    //float scaledValue = (value * 0.5 + 0.5) * (rangeMax - rangeMin) + rangeMin;
